...
public class ArmyUnit extends Entity
{
	...
	public void update()
	{
		...
		if(isCombatMode())
		{
			...
			if(timer > limit)
			{
				...
				if(!level.isPlayerEntitySelected())
				{
						...
						if(dmg > 0 )
					{
						...
						{
							level.getParticleEntities().add(new Particle(level.getPlayer().xScroll + this.target1.getPixel64X(), level.getPlayer().yScroll + this.target1.getPixel64Y(), 32));
						}
					}
					endAttack(dmg*-1);
				...
				else
				{
					...
					if(dmg > 0)
					{
						...
						{
							level.getParticleEntities().add(new Particle(this.target1.getPixel64X(), this.target1.getPixel64Y(), 32));
						}
					}
			...
			else
			{
				...
				// Check to the right
				if(this.getCenter64X()+1 == level.getEnemyArmyEntities().get(i).getCenter64X() && this.getCenter64Y() == level.getEnemyArmyEntities().get(i).getCenter64Y())
				{					
					if(this.unitClass == UnitClass.Archer)
					{
				...
				// Check to the left
				else if(this.getCenter64X()-1 == level.getEnemyArmyEntities().get(i).getCenter64X() && this.getCenter64Y() == level.getEnemyArmyEntities().get(i).getCenter64Y())
				{
					if(this.unitClass == UnitClass.Archer)
					{
				...
				// Check above
				else if(this.getCenter64Y()-1 == level.getEnemyArmyEntities().get(i).getCenter64Y() && this.getCenter64X() == level.getEnemyArmyEntities().get(i).getCenter64X())
				{
					if(this.unitClass == UnitClass.Archer)
					{
				...
				else if(this.getCenter64X()+2 == level.getEnemyArmyEntities().get(i).getCenter64X() && this.getCenter64Y() == level.getEnemyArmyEntities().get(i).getCenter64Y())
				{					
					if(this.unitClass == UnitClass.Archer)
					{
						setImage(Assets.archerAttackAnimRight.getImage());
				...
				// Check above +2
				else if(this.getCenter64Y()-2 == level.getEnemyArmyEntities().get(i).getCenter64Y() && this.getCenter64X() == level.getEnemyArmyEntities().get(i).getCenter64X())
				{
					if(this.unitClass == UnitClass.Archer)
					{
						setImage(Assets.archerAttackAnimUp.getImage());	
		...
		for(int i = 0; i < level.getDroppedResourceEntities().size(); i++)
		{
			if(level.getDroppedResourceEntities().get(i).getCenter64X() == getCenter64X() && level.getDroppedResourceEntities().get(i).getCenter64Y() == getCenter64Y())
			{
				...
				if(level.getDroppedResourceEntities().get(i).getResourceType().equals(ResourceType.Food))
				{
					...
					level.getPlayer().setFood(level.getPlayer().getFood() + 3);
				...
				else if(level.getDroppedResourceEntities().get(i).getResourceType().equals(ResourceType.Gold)) 
				{
					...
					level.getPlayer().setGold(level.getPlayer().getGold() + 4);
					level.getDroppedResourceEntities().get(i).setVisible(false);
				}
	...
	public void endAttack(int dmg)
	{
		...
		level.getEnemyArmyEntities().get(i).setTarget(new Entity(this));;
		...
		level.getEnemyArmyEntities().get(i).addHealth(dmg);
	...
	public void endPlayerInitiatedAttack(int dmg)
	{
		...
		level.getEnemyArmyEntities().get(i).getTarget().setPixel64X(this.lastTargetX); 
		level.getEnemyArmyEntities().get(i).getTarget().setPixel64Y(this.lastTargetY);
		//GameManager.level.getEnemyArmyEntities().get(i).setTarget(new Entity(this));;
		level.getEnemyArmyEntities().get(i).addHealth(dmg);
	...
	public int calculateDmg() 
	{
		...
		else
		{
			...
			return (r * atkRating) - level.getEnemyArmyEntities().get(targetLinkPos).getDefRating();
		}
	}
	...
	{
		//  Right
		if(level.getEnemyArmyEntities().get(i).getCenter64X() + 1 == this.center64X && level.getEnemyArmyEntities().get(i).getCenter64Y() == this.center64Y)
		{
			return 1;
		}
		// Left
		else if(level.getEnemyArmyEntities().get(i).getCenter64X() - 1 == this.center64X && level.getEnemyArmyEntities().get(i).getCenter64Y() == this.center64Y)
		{
			return 3;
		}
		// Down
		else if(level.getEnemyArmyEntities().get(i).getCenter64X() == this.center64X && level.getEnemyArmyEntities().get(i).getCenter64Y() - 1 == this.center64Y)
		{
			return 0;
		}
		// Up
	...
	public void attack(int i) 
	{
		...
		this.gridMoves--;
		this.target1 = new Entity(level.getEnemyArmyEntities().get(i));
	...
	public int getTargetsDmgBasedOnDir(int dir, int dirOfTarget, int dmg)
	{
		 switch(dirOfTarget)
		 {
		 	case 0: // target is below
		 		...
		 		if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.DOWN)
		 		{
		 			return dmg;
		 		}
		 		// check for target facing either side, inflict 25% of bonus dmg
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.LEFT || level.getPlayerArmyEntities().get(this.targetLinkPos).getDirection() == Direction.RIGHT)
		 		{
		 			return dmg;
		 		}
		 		// check for target facing forward, no bonus dmg.
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.UP)
		 		{
		 			return dmg;
		 		}
		 		break;
		 	...
		 	case 1: // target is to the right
		 		...
		 		if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.RIGHT)
		 		{
		 			return dmg;
		 		}
		 		// check for target facing down or forward, inflict 25 % bonus dmg
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.DOWN || level.getPlayerArmyEntities().get(this.targetLinkPos).getDirection() == Direction.UP)
		 		{
		 			return dmg;
		 		}
		 		// check for target facing left, no bonus dmg
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.LEFT)
		 		{
		 			return dmg;
		 		}
		 		break;
		 	...
		 	case 2: // target is above
		 		...
		 		if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.UP)
		 		{
		 			return dmg;
		 		}
		 		...
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.DOWN)
		 		{
		 			return dmg;
		 		}
		 		break;
		 	...
		 	case 3: // target is to the left
		 		...
		 		if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.LEFT)
		 		{
		 			return dmg;
		 		}
		 		// check for target facing down or forward, inflict 25 % bonus dmg
		 		...
		 		else if(level.getEnemyArmyEntities().get(this.targetLinkPos).getDirection() == Direction.RIGHT)
		 		{
		 			return dmg;
		 		}
		 		break;
