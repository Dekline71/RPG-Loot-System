...
public class GameScreen extends Screen
{
	...
	public GameScreen(LotusRenderView game, String tribe)  
	{		
		super(game);
		...
		level.getPlayer().setTribe(tribe);// init new game player tribe
		...
		/*
		level.getEnemyArmyEntities().add(new Enemy(55, 85, level, UnitType.Melee));
		level.getEnemyArmyEntities().add(new Enemy(56, 86, level, UnitType.Melee));
		level.getEnemyArmyEntities().add(new Enemy(60, 90, level, UnitType.Melee));
		level.getEnemyArmyEntities().add(new Enemy(60, 88, level, UnitType.Melee));
		
		level.getPlayerArmyEntities().add(new Spearman(62, 91, level, UnitType.Melee, UnitClass.Spearman));
		level.getPlayerArmyEntities().add(new Spearman(60, 87, level, UnitType.Melee, UnitClass.Spearman));
		level.getPlayerArmyEntities().add(new Spearman(66, 88, level, UnitType.Melee, UnitClass.Spearman));
		level.getPlayerArmyEntities().add(new Spearman(66, 98, level, UnitType.Melee, UnitClass.Spearman));
		level.getPlayerArmyEntities().add(new Archer(68, 92, level, UnitType.Ranged, UnitClass.Archer));
		level.getPlayerArmyEntities().add(new Archer(68, 90, level, UnitType.Ranged, UnitClass.Archer));
		level.getPlayerArmyEntities().add(new Archer(68, 98, level, UnitType.Ranged, UnitClass.Archer));
		*/
